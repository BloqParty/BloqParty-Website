...
console.debug(`Getting static variables...`);

let staticVars = {};

try {
    if(require(`./session`).dev || process.argv.includes(`build`)) throw new Error(``);
    staticVars = JSON.parse(fs.readFileSync(`./static.json`, `utf8`))
} catch(e) {};
